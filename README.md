...
### 🔗 地面连接线
- **动态连接**：无人机与地面固定点之间的实时虚线连接
- **自动更新**：连接线随无人机移动而实时更新
- **视觉效果**：白色虚线，带有半透明间隙，始终显示在最前面
- **固定点**：默认连接到经纬度 (117.229619, 31.726288)
- **显隐控制**：支持与无人机和轨迹同步显示/隐藏
...
### 地面连接线
**对应的 TypeScript 文件**：`src/components/cesiumMap/ts/groundLink.ts`
