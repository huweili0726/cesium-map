...
import { validateTimeInput, queryTrackChunk, createReplayEngine, cleanupReplayResources, TrackPreloader, REPLAY_CONFIG } from '@/utils/timeRangeReplay'
...
const toSetHemisphere = () => {
  // 设置半球 （通过提供的glb模型设置点位）
  setHemisphere({id: '6', center: [117.228433, 31.723159, 0], radius: 1000, sphericalColor: 'rgba(20, 239, 255, 0.2)', label: '半球体', labelBgColor: 'rgba(0, 118, 131, 1)'});
}
